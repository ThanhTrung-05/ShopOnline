...
var o = (e2, t2) => {
  ...
  for (let n3 in e2) {
    let c2 = e2[n3];
    "@" == n3[0] ? "i" == n3[1] ? r = n3 + " " + c2 + ";" : a2 += "f" == n3[1] ? o(c2, n3) : n3 + "{" + o(c2, "k" == n3[1] ? "" : t2) + "}" : "object" == typeof c2 ? a2 += o(c2, t2 ? t2.replace(/([^,])+/g, (e3) => n3.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g, (t3) => /&/.test(t3) ? t3.replace(/&/g, e3) : e3 ? e3 + " " + t3 : t3)) : n3) : null != c2 && (n3 = "-" == n3[1] ? n3 : n3.replace(/[A-Z]/g, "-$&").toLowerCase(), l3 += o.p ? o.p(n3, c2) : n3 + ":" + c2 + ";");
  }
  return r + (t2 && l3 ? t2 + "{" + l3 + "}" : l3) + a2;
};
var c = {};
var i = (e2) => {
  if ("object" == typeof e2) {
...
var p = (e2, t2, r) => e2.reduce((e3, a2, l3) => {
  let n3 = t2[l3];
  if (n3 && n3.call) {
...
function w(e2, t2) {
  ...
  return function() {
    let a2 = arguments;
    function l3(n3, o2) {
      let c2 = Object.assign({}, n3), i2 = c2.className || l3.className;
