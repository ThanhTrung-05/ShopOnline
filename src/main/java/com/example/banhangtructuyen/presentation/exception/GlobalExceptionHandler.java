...
public class GlobalExceptionHandler {
    ...
    /**
     * ATS-14: Handles insufficient inventory when customer requests more than available stock.
     * Returns HTTP 422 Unprocessable Entity per the AddToCart and UpdateCart sequence diagrams.
     */
